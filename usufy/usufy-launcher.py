...
import usufy.lib.processing as processing

import i3visiotools.wrappers.platforms as platforms
...
def usufy_main(args):
	...
	logger = __init__.setupLogger(args.verbose)

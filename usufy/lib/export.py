...
def resultsToJson(profiles):
	""" 
		...
		:param profiles:	a dictionary with the information of the profiles.

		:return:	jsonText as the string to be written in Json file.                              
	"""
	logger = logging.getLogger("usufy")
	...
	jsonText =  json.dumps(profiles, sort_keys=True, indent=2)
	return jsonText

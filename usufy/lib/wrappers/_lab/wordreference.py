...
class Wordreference(Platform):
	""" 
		A <Platform> object for Demo using Wordreference.
	"""
	def __init__(self):
		""" 
			Constructor... 
		...
		self.platformName = "Wordreference"
	...
	def _getAuthenticated(self, uBrowser):
		...
		if len(self.creds) > 0:
			...
			if DEVELOPING:
				...
				formNumber = 0 # Change this number with the appropriate number

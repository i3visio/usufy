...
class Lamarihuana(Platform):
	""" 
		A <Platform> object for Lamarihuana.
	"""
	def __init__(self):
		""" 
			Constructor... 
		"""
		self.platformName = "Lamarihuana"
		# Add the tags for the platform
		self.tags = ["social", "news"]
		self.NICK_WILDCARD = "<HERE_GOES_THE_NICK>"
		# Add the URL below
		self.url = "http://www.lamarihuana.com/foros/members/" + self.NICK_WILDCARD + ".115111/"
